...
# Key Modifications
1. Interactive Hole Masking: A new feature that allows users to manually select the hole area via mouse clicks to exclude noisy data and artifacts.
2. Stress Concentration Focus: The post-processing logic is optimized to visualize local strain distribution around a circular discontinuity.
3. Student-Friendly Guide: Updated instructions and error-handling for Windows-based Python environments.
